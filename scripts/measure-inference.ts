...
const schema = z.toJSONSchema(interviewModelSchema(context, interviewSchemaFor("answer")));
for (const duplicateSchema of [true, false, false, true]) {
  ...
  parseInterviewModelResult(context, interviewSchemaFor("answer"), JSON.parse(raw));

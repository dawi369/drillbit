...
const operations: [string, string, string, string?][] = [
  ...
  ["delete", "developer/practice", "Clear owner development practice data while preserving account configuration"],
  ...
  ["post", "daily-question", "Check the first account-local visit of the day and reuse or prepare a question"],
  ["get", "bootstrap", "Get account, settings, active challenge and jobs"],
  ["post", "invite", "Redeem a single-use invitation", "InviteInput"],
  ["post", "settings/preview", "Preview practice personalization without saving or creating an attempt", "PracticeProfile"],
...
const responseNames: Record<string, string> = {
  ...
  "post daily-question": "DailyQuestion",
  "post invite": "OK",
  "put settings": "Settings",
  "post settings/preview": "PersonalizationPreview",

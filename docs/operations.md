...
Build 7 packages the latency-sensitive interview pipeline, ephemeral Nudge/Example presentation, permission-gated voice entry, Home/recovery refinements and the monochrome native visual pass. Its archive/export result and TestFlight processing state are recorded after distribution rather than inferred from compilation.
